...
- The Python GUI bindings used by this build are distributed under GPL v3 or
  a commercial license. This share package includes the matching application
  source and the GPL v3 text.
- Qt runtime libraries are collected by the freezing tool and retain their own
  license notices and terms.
...
This notice records provenance considerations; it does not replace the license
texts shipped by each component.
